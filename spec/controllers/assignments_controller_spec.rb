  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved assignment as @assignment" do
        ...
        post :create, {:assignment => { "type_id" => "invalid value" }}, valid_session
        assigns(:assignment).should be_a_new(Assignment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested assignment" do
        ...
        Assignment.any_instance.should_receive(:update_attributes).with({ "type_id" => "1" })
        put :update, {:id => assignment.to_param, :assignment => { "type_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the assignment as @assignment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Assignment.any_instance.stub(:save).and_return(false)
        put :update, {:id => assignment.to_param, :assignment => { "type_id" => "invalid value" }}, valid_session
        assigns(:assignment).should eq(assignment)
      end

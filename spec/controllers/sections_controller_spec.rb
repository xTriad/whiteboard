  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved section as @section" do
        ...
        post :create, {:section => { "course_id" => "invalid value" }}, valid_session
        assigns(:section).should be_a_new(Section)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested section" do
        ...
        Section.any_instance.should_receive(:update_attributes).with({ "course_id" => "1" })
        put :update, {:id => section.to_param, :section => { "course_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the section as @section" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Section.any_instance.stub(:save).and_return(false)
        put :update, {:id => section.to_param, :section => { "course_id" => "invalid value" }}, valid_session
        assigns(:section).should eq(section)
      end
